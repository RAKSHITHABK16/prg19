...
choices_month=[('1','Jan'),('2','Feb'),('3',"Mar"),("4","April")]
...
class SampleForm(forms.Form):
    ...
    #phno=forms.IntegerField(max_value=9999999999,min_value=6000000000,required=True,label="Phone No",help_text="No courty codes")
    phno=forms.CharField(max_length=10,min_length=10,required=True,widget=forms.TextInput(attrs={'pattern':'[6-9]\d{9}'}))
